...
echo ""
echo "📋 Next steps:"
echo "1. Deploy the frontend build to your static hosting (S3+CloudFront at townwink.com)"
echo "2. Ensure DNS for api.townwink.com points to the API Gateway custom domain created by Serverless"
